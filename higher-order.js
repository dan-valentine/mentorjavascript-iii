...
let evenNumbers = mixedNumbers.filter((e,i,a) => e%2 === 0);
...
let postTaxPrices = prices.map((e,i,a) => e*1.07);
...
let totalPopulation = populations.reduce((p, e, i, a) => {return p+e}, 0);
...
let ordersTotal = orders.map((e, i, a) => e.price + e.price*e.tax);
ordersTotal
...
let bobsTotal = purchases.reduce((pre, e, i, a)=> {return e.owner === 'Bob' ? pre + e.price: pre}, 0)// Your code here
